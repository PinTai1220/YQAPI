...
namespace DAL
{
    public class OrdersDAL : IDALServices<Orders>
    {
        ...
        {
            string sql = "select a.*,b.Phone_Num,c.Room_Num from Orders a join UserInfos b on a.User_Id=b.UserInfo_Id  join Rooms c on a.Room_State=c.Room_Id order by a.Order_Time desc";
